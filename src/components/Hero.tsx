      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center animate-fade-in">
        <div className="inline-block shadow-x1 rounded">
          ...
          <h1 className="text-4xl md:text-4xl font-bold mb-6">
            Pare de gerir ferramentas. Comece a conversar com a sua agenda.
          </h1>
          {/* <p className="text-paragraph mb-6 text-lg">
            Conheça o LLENO, seu assistente virtual que ajuda alunos como
            Carimbo Miguel a organizar festas escolares incríveis — tudo pelo
            WhatsApp.
          </p> */}
          ...
          <a
            ...
            className="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 
                       text-black font-semibold px-8 py-3 rounded-full shadow-lg 
